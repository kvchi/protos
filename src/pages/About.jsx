  ...
  return (
    <main>
      <div className='md:px-28 py-16 relative'>
       ...
       <div className="absolute inset-0 bg-[#0E375F]/50 md:right-28 md:left-28 bottom-16 top-16"></div>
      ...
      <div className='flex flex-col items-center justify-center  text-[#0E375F] font-semibold mb-10 px-8 lg:px-28'>
