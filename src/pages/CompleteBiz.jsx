...
export default function CompleteBiz() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("postLoginRedirect", "/signup1");
      ...
      if (error.response?.data) {
        ...
        if (backendErrors.non_field_errors) {
          ...
          alert(
            "There was an error creating your account. Please check your inputs.",
          );
        }
      } else {
        ...
        <form onSubmit={handleSubmit} noValidate className="mt-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="md:w-[80%] lg:w-[100%] font-medium text-sm mt-6">
              ...
              <span className="text-accent underline">Business Terms</span> and
              acknowledge our{" "}
              <span className="text-accent underline">Privacy Policy.</span> We
              may email you about Protos products, services and local events.
