...
export default function Map() {
  ...
  return (
    <main className="flex flex-col-reverse lg:flex-row w-full h-full lg:px-20 overflow-hidden bg-secondary/80 lg:bg-white"> 
      <div className="sm:w-[40%] md:w-[100%] lg:w-[24%] lg:bg-secondary px-4 border-r-2 border-gray-200 overflow-y-auto my-2">
        <div className=" py-4">
          ...
          {icons.map((IconComponent, i) => {
            ...
            return (
              <div
                ...
                className={`rounded-full border p-2 flex items-center justify-center hover:bg-gray-100 transition ${
                  isActive
